...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('buku.index')); ?>">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('buku.create')); ?>">
    ...
    <footer class="footer-custom text-center">
        <div class="container">
            <p class="mb-0 text-muted">
                ...
                Sistem Daftar Buku &copy; <?php echo e(date('Y')); ?>
...
<?php /**PATH C:\xampp\htdocs\daftar_buku\resources\views/layout.blade.php ENDPATH**/ ?>