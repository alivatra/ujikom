        ...
        <div class="col-lg-6">
            <div class="card card-custom">
                <div class="card-body p-4">
                    ...
                    <!-- Form -->
                    <form action="<?php echo e(route('buku.store')); ?>" method="POST" id="bukuForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    class="form-control form-control-custom <?php $__errorArgs = ['judul'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    class="form-control form-control-custom <?php $__errorArgs = ['penulis'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number"
                                    class="form-control form-control-custom <?php $__errorArgs = ['tahun'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <?php else: ?>
                            <small class="text-muted">Tahun antara 1900 - <?php echo e(date('Y')); ?></small>
                            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <a href="<?php echo e(route('buku.index')); ?>" class="btn btn-outline-cream flex-grow-1">
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\daftar_buku\resources\views/buku/create.blade.php ENDPATH**/ ?>